...
<h1
	class="title-font mx-auto hidden text-center font-bold text-primary-600 sm:mt-4 sm:block sm:text-4xl"
>
	Strengthen OUR Community
</h1>
<h1 class="h1 mx-auto mt-2 text-center">Thank you for completing the questionnaire.</h1>
<div class="text-scale-3 sm:text-scale-6 mx-auto w-3/5">
