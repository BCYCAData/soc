<script lang="ts">
	...
	let communityWorkshopChoices = $state(
		data.user_profile?.community_bcyca_profile?.community_workshop_choices
	);
	let otherCommunityWorkshop = $state(
		data.user_profile?.community_bcyca_profile?.other_community_workshop
	);
	...
	function handleReset() {
		if (confirm('Are you sure you want to undo? All unsaved changes will be lost.')) {
			...
			communityWorkshopChoices =
				data.user_profile?.community_bcyca_profile?.community_workshop_choices;
			otherCommunityWorkshop = data.user_profile?.community_bcyca_profile?.other_community_workshop;
