<script lang="ts">
	...
	let communityWorkshopChoices = $state(
		data.user_profile.community_mondrook_profile?.community_workshop_choices
	);
	let otherCommunityWorkshop = $state(
		data.user_profile.community_mondrook_profile?.other_community_workshop
	);
	let willRunCommunityWorkshops = $state(
		data.user_profile.community_mondrook_profile?.will_run_community_workshops
	);
