<script lang="ts">
	...
	let communityWorkshopChoices = $state(
		data.user_profile?.community_tinonee_profile?.community_workshop_choices
	);
	let otherCommunityWorkshop = $state(
		data.user_profile?.community_tinonee_profile?.other_community_workshop
	);
	let willRunCommunityWorkshops = $state(
		data.user_profile?.community_tinonee_profile?.will_run_community_workshops
	);
