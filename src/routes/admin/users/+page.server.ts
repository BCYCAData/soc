...
export const load: PageServerLoad = async ({ locals: { supabase, getSessionAndUser }, parent }) => {
	...
	if (!parentData.permissions.includes('admin.users')) {
		console.error('Forbidden attempt on /admin/users:', user);
...
export const actions: Actions = {
	testemail: async ({ request, locals: { supabase, getSessionAndUser } }) => {
