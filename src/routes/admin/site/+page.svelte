<script lang="ts">
	...
	let { siteAdminData } = $derived(data);
</script>
...
<div>
	...
	<h2 class="unstyled mt-2 text-base font-semibold text-gray-900">
		Currently you can use these pages to:
	</h2>
	...
	<dl class="list-dl">
		<div>
			...
			<span class="flex-auto">
				<dt class="font-bold">Set User Messages</dt>
